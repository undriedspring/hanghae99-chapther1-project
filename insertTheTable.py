...
docs = [
        ...
        },
        {
            'id': 10,
            'title': '경종수정실록',
            'desc': '당쟁의 대립 속에서 서로 다른 세상을 꿈꾸었던 자들의 이야기 숙종과 생모 장희빈에 대한 트라우마를 안고 성장한 조선의 20대 왕, 경종.그의 병환이 노출되면서 왕권은 흔들리기 시작한다. 왕위를 노리는 이복동생 연잉군(훗날 영조)과 정면 승부를 통해 경종은 점점 변모해 간다. 그리고 두 형제를 붓으로 기록하고 있는 홍수찬이 있다. 기록되지 않은, 기록할 수 없었던 그 날 새벽 검은 복장의 자객의 칼이 경종의 심장을 향한다. 홍수찬, 경종과 자객을 보고도 외면 한 채 기록을 멈추지 않는다. 그리고 꿈속에서 깨어난다...'
        },
        {
            'id': 11,
            'title': '젠틀맨스가이드',
            'desc': '1909년 영국 런던. 낮은 신분으로 가난하게 살아가던 ‘몬티’는 어느 날 자신이 고귀한 ‘다이스퀴스’ 가문의 여덟 번째 후계자라는 사실을 알게 된다. 이 기쁜 소식을 사랑하는 연인 ‘시벨라’에게 털어놓지만, 그에게 돌아오는 냉정한 한마디! “네가 어떻게 백작이 돼, 네 앞의 8명이 죽어야 되는데, 그게 가능해?” 지렁이도 두 발로 직립 보행하는 날이 오고야 말리라! ‘몬티’는 ‘다이스퀴스’ 가문 백작의 자리에 오르기 위해 기상천외한 방법을 동원하는데… ‘몬티’ 앞에 나타난 닮은 듯 다른 여덟 명의 ‘다이스퀴스’ 가문의 후계자들! 갈수록 상황은 점차 꼬여만 가고 ‘몬티’는 과연 무사히 다이스퀴스 가문의 백작이 될 수 있을까?'
        },
        {
            'id': 12,
            'title': '작은아씨들',
            'desc': '따뜻한 성격의 아름다운 첫째 메그, 쾌활하고 진취적인 둘째 조, 수줍음이 많고 선량한 셋째 베스, 당당하고 야무진 막내 에이미. 마치家의 네 자매는 남북전쟁으로 집을 떠난 아버지의 부재로 형편이 어려워지지만 지혜롭고 현명한 어머니의 사랑 속에 서로 의지하며 어린 시절을 보낸다. 물질적으로 풍족하지 않아도 더 어려운 이웃을 위해 기꺼이 나눌 수 있는 사랑이 넘치는 네 자매. 이들은 부유한 이웃집 로렌스家의 손자 로리와 함께 우정을 쌓아가며 성장해간다. 시간이 흘러 아버지가 전쟁터에서 돌아오시고 네 자매는 각기 다른 자신의 인생을 펼쳐나가는데…'
        }
]
